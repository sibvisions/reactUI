...
// Interface for extendable-text-cell-editor
...
// This component is an empty substitute for the component UIEditorText
const ExtendTextEditor: FC<IExtendableTextEditor> = () => {
    return (
        <>
        </>
    )
