...
const UISwitch: FC<IEditorCheckBox> = (props) => {
    /** Reference for the switch component */
    const switchRef = useRef<any>();

    /** Reference for wrapper element */
    ...
    const isHTML = useIsHTMLText(getButtonText(props, props));
        ...
        <span
            ...
            {!props.isCellEditor &&
                <label
                    ...
                    htmlFor={id}>
                    {isHTML && (props.cellEditor_text_ || props.cellEditor.text) ? <RenderButtonHTML text={getButtonText(props, props)} />
                        : getButtonText(props, props)}
                </label>
            }
        </span>
    )
