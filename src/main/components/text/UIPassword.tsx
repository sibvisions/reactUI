                ...
                onBlur={(event) => {
                    if (!isCompDisabled(props)) {
                        ...
                        if (startedEditing.current) {
                            ...
                            sendAction(props.name, pwValue, "FOCUS_LOST", props.context.server, props.topbar);
                        }
                ...
                onKeyDown={(event) => {
                    if (event.key === "Enter") {
                        ...
                        if (startedEditing.current) {
                            ...
                            sendAction(props.name, pwValue, event.shiftKey ? "SHIFT_ENTER_KEY" : "ENTER_KEY", props.context.server, props.topbar);
                        }
                    }
                }}
