 ...
 * @param values - properties for the reload-request
 * @returns a reload-request object
 */
 ...
 * @returns an about-request object
 */
...
/**
 * Returns a width-request object with either properties which can be overwritten or properties as parameters
 * @param values - properties for the width-request
 * @returns an width-request object
 */
...
/**
 * Returns a getDesignerComponents-request object with either properties which can be overwritten or properties as parameters
 * @param values - properties for the getDesignerComponents-request
 * @returns an getDesignerComponents-request object
 */
...
/**
 * Returns a createNewComponents-request object with either properties which can be overwritten or properties as parameters
 * @param values - properties for the createNewComponents-request
 * @returns an createNewComponents-request object
 */
