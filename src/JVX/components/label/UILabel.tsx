...
const UILabel: FC<BaseComponent> = (baseProps) => {
    ...
    return(
        <span ref={labelRef} dangerouslySetInnerHTML={{__html: props.text as string}} className={"jvxLabel" + ((props.text as string).includes("<html>") ? " jvxLabel-html" : "")} style={layoutValue.get(props.id) ? {
