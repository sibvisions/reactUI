...
export const LoginForm:FC = () => {
    ...
    const btnBgd = window.getComputedStyle(document.documentElement).getPropertyValue('--' + context.appSettings.applicationMetaData.applicationColorScheme + '-button-color');
